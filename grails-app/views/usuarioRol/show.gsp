...
<html>
    ...
    <body>
        ...
        <div id="show-usuarioRol" class="content scaffold-show" role="main">
            ...
            <f:display bean="usuarioRol" />
            <g:form resource="${this.usuarioRol}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.usuarioRol}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
